...
var GrowingArray, MAX_REMOVALS_BEFORE_SWAP, ObjectStorage, RBush, SortableStack, TmpBbox, bboxArea, bboxMargin, calcBBox, contains, createNode, distBBox, enlargedArea, extend, intersectionArea, intersects, rayBboxDistance;
...
GrowingArray = /*@__PURE__*/(function () {
  ...
  var double = ref.double; if ( double === void 0 ) double = false;
    ...
    this[Symbol.iterator] = function*() {
      var i, j, ref;
      for (i = j = 0, ref = this.currentLen; (0 <= ref ? j < ref : j > ref); i = 0 <= ref ? ++j : --j) {
