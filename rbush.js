...
var MAX_REMOVALS_BEFORE_SWAP, ObjectStorage, RBush, bboxArea, bboxMargin, calcBBox, contains, createNode, distBBox, enlargedArea, extend, intersectionArea, intersects;

MAX_REMOVALS_BEFORE_SWAP = 50;

ObjectStorage = /*@__PURE__*/(function () {
  function ObjectStorage() {
    this.size = 500;
    this.current = this.arr1 = new Array(this.size);
    this.other = this.arr2 = new Array(this.size);
    this.currentLen = 0;
    this.removalsCount = 0;
  }

  ObjectStorage.prototype.add = function add (item) {
  ...
  ObjectStorage.prototype.enlarge = function enlarge () {
...
RBush = /*@__PURE__*/(function () {
  ...
  if ( maxEntries === void 0 ) maxEntries = 9;
    ...
    this._stacks = [0, 1, 2, 3, 4, 5, 6, 7, 8].map(function() {
      return Array(maxEntries);
    });
    this.nonStatic = new ObjectStorage();
    this.clear();
  }
  ...
  RBush.prototype._splitRoot = function _splitRoot (node, newNode) {
    ...
    if (this.data.height === this._stacks.length) {
      this._stacks.push(Array(this._maxEntries));
    }
