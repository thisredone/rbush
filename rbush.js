...
}(this, (function (boxIntersect) { 'use strict';

boxIntersect = boxIntersect && Object.prototype.hasOwnProperty.call(boxIntersect, 'default') ? boxIntersect['default'] : boxIntersect;
...
var GrowingArray, GrowingArrayPool, LeafNodes, MAX_REMOVALS_BEFORE_SWAP, ObjectStorage, RBush, SortableStack, TmpBbox, bboxArea, bboxMargin, boxIntersect2, boxIntersect3, calcBBox, contains, createNode, distBBox, enlargedArea, extend, intersectionArea, intersects, rayBboxDistance;

((assign = boxIntersect, boxIntersect2 = assign.boxIntersect2, boxIntersect3 = assign.boxIntersect3));

MAX_REMOVALS_BEFORE_SWAP = 50;

TmpBbox = (function() {
  var CACHE_SIZE, bboxes, i, l, nextBbox, ref;
  ...
  for (i = l = 0, ref = CACHE_SIZE; (0 <= ref ? l < ref : l > ref); i = 0 <= ref ? ++l : --l) {
...
ObjectStorage = /*@__PURE__*/(function (GrowingArray) {
  ...
  ObjectStorage.prototype.condense = function condense () {
    var index, item, l, newIndex, ref;
    newIndex = 0;
    for (index = l = 0, ref = this.currentLen; (0 <= ref ? l < ref : l > ref); index = 0 <= ref ? ++l : --l) {
...
RBush = /*@__PURE__*/(function () {
  ...
  RBush.prototype.checkCollisions = function checkCollisions (cb) {
    ...
    var c, current, currentLen, i, index, item, l, leaf, leafs, len, len1, n, newIndex, o, other, otherLeaf, overlapping, q, r, ref, ref1, ref2, ref3, ref4, removalsCount, swapping;
    ...
    for (i = l = 0, ref = this.leafNodes.currentLen; (0 <= ref ? l < ref : l > ref); i = 0 <= ref ? ++l : --l) {
      leaf = leafs[i];
      if (!leaf._removed) {
        leaf.overlapping.currentLen = 0;
      }
    }
    boxIntersect2(leafs, this.leafNodes.currentLen, function(i, j) {
      var l1, l2;
      l1 = leafs[i];
      l2 = leafs[j];
    ...
    for (index = n = 0, ref1 = currentLen; (0 <= ref1 ? n < ref1 : n > ref1); index = 0 <= ref1 ? ++n : --n) {
      item = current[index];
      ...
      if (overlapping.currentLen) {
        for (i = q = 0, ref3 = overlapping.currentLen; (0 <= ref3 ? q < ref3 : q > ref3); i = 0 <= ref3 ? ++q : --q) {
  ...
  RBush.prototype.raycast = function raycast (origin, dir, range, predicate) {
    ...
    var child, dstX, dstY, invDirx, invDiry, item, l, len, len1, len2, n, node, o, popped, ref, ref1, ref2, stack, t, tmin;
    node = this.data;
    invDirx = 1 / dir.x;
    invDiry = 1 / dir.y;
  ...
  RBush.prototype._all = function _all (node, predicate) {
    var child, i, l, len, len1, n, ref, ref1;
  ...
  RBush.prototype._chooseSubtree = function _chooseSubtree (bbox, node) {
    var area, child, enlargement, l, len, minArea, minEnlargement, ref, targetNode;
    while (true) {
      if (node.leaf) {
        break;
      }
  ...
  RBush.prototype._chooseSplitIndex = function _chooseSplitIndex (node, m, M) {
    var area, bbox1, bbox2, i, index, l, minArea, minOverlap, overlap, ref, ref1;
    index = null;
    minOverlap = 2e308;
    minArea = 2e308;
    i = m - 1;
    for (i = l = ref = m, ref1 = M - m; (ref <= ref1 ? l <= ref1 : l >= ref1); i = ref <= ref1 ? ++l : --l) {
  ...
  RBush.prototype._allDistMargin = function _allDistMargin (node, m, M, compare) {
    var child, i, l, leftBbox, margin, n, ref, ref1, ref2, ref3, rightBbox;
    ...
    for (i = n = ref2 = M - m - 1, ref3 = m; (ref2 <= ref3 ? n <= ref3 : n >= ref3); i = ref2 <= ref3 ? ++n : --n) {
      child = node.children[i];
...
distBBox = function(node, k, p, destNode) {
  var bbox, i, l, ref, ref1, ref2;
  bbox = (ref = destNode != null ? destNode.bbox : void 0) != null ? ref : TmpBbox.get();
  bbox[0] = 2e308;
  bbox[1] = 2e308;
  bbox[2] = -2e308;
  bbox[3] = -2e308;
  for (i = l = ref1 = k, ref2 = p; (ref1 <= ref2 ? l < ref2 : l > ref2); i = ref1 <= ref2 ? ++l : --l) {
